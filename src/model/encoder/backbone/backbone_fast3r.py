...
class Fast3R(nn.Module,
    ...
    def _encode_images(self, views, chunk_size=400):
        ...
        if same_shape:
            ...
            encoded_feats = torch.split(feats, B, dim=0) # V B L C
...
class Fast3RDecoder(nn.Module):
    def __init__(
        ...
        self.decoder_embed = nn.Linear(enc_embed_dim, embed_dim, bias=True) #1024 -> 768
